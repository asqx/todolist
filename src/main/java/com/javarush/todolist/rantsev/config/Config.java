package com.javarush.todolist.rantsev.config;
...
@EnableWebMvc
@EnableJpaRepositories("com.javarush.todolist.rantsev.dao")
@ComponentScan("com.javarush.todolist.rantsev")
@Configuration
public class Config implements WebMvcConfigurer {
    ...
    public void configureViewResolvers(ViewResolverRegistry registry) {
        ...
        resolver.setCharacterEncoding("UTF-8"); // Добавленная строка
